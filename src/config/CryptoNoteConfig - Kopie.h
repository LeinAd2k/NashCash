...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t MONEY_SUPPLY                             = UINT64_C(4800000000000000); // 48 mil / 8 decimals
        ...
        const uint64_t GENESIS_BLOCK_TIMESTAMP                           =                                1546355699;
        ...
        const size_t   NORMAL_TX_MAX_OUTPUT_RATIO_V1_HEIGHT =                                                        300000;

        const uint32_t UPGRADE_HEIGHT_V2                    =                 5; // Upgrade height for CN-Dark Variant 1 switch
        const uint32_t UPGRADE_HEIGHT_V3                    =                20; // Upgrade height for CN-Dark Lite Variant 1 switch
        ...
        const uint32_t UPGRADE_HEIGHT_V6                    =            41; // Upgrade height for Chukwa switch. 
    ...
    const char     DATADIR_NAME[]              =              "NashCash";
