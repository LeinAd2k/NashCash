...
#define PROJECT_NAME "NashCash"
#define PROJECT_SITE "http://www.nashcash.net"
#define PROJECT_COPYRIGHT "Copyright 2018, The NashCash developers"
#define APP_VER_MAJOR 0
#define APP_VER_MINOR 12
#define APP_VER_REV 0
#define APP_VER_BUILD 1280
